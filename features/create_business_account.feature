Feature: Set up business account
...
Background:
    Given I am on the business user signup page
...
Scenario: I correctly enter my signup credentials
    ...
    Then I should be on the business page for "jdoe1@binghamton.edu"
...
Scenario: I leave "Email" empty
    ...
    Then I should be on the business user signup page
